...
## Table of Contents
  ...
  - [**nano /etc/network/interfaces**](#nano-etcnetworkinterfaces)
  - [**systemctl restart networking**](#systemctl-restart-networking)
  - [**nano /etc/network/interfaces**](#nano-etcnetworkinterfaces)
  - [**systemctl restart networking**](#systemctl-restart-networking)
  - [**mcedit /etc/net/ifaces/ens18/options**](#mcedit-etcnetifacesens18options)
  - [**mcedit /etc/net/ifaces/ens18/ipv4address**](#mcedit-etcnetifacesens18ipv4address)
  - [**mcedit /etc/net/ifaces/ens18/ipv4route**](#mcedit-etcnetifacesens18ipv4route)
  - [**mcedit /etc/net/ifaces/ens18/options**](#mcedit-etcnetifacesens18options)
  - [**mcedit /etc/net/ifaces/ens18/ipv4address**](#mcedit-etcnetifacesens18ipv4address)
  - [**mcedit /etc/net/ifaces/ens18/ipv4route**](#mcedit-etcnetifacesens18ipv4route)
  ...
  - [**nano /etc/network/interfaces**](#nano-etcnetworkinterfaces)
  - [**systemctl restart networking**](#systemctl-restart-networking)
  - [**nano /etc/sysctl.conf**](#nano-etcsysctlconf)
  - [**net.ipv4.ip_forward=1**](#netipv4ip_forward1)
  - [**iptables-save > /etc/rules.v4**](#iptables-save--etcrulesv4)
  - [**crontab -e**](#crontab--e)
  ...
  - [**mcedit /etc/sudoers**](#mcedit-etcsudoers)
  - [**mkdir /home/net_admin**](#mkdir-homenet_admin)
  - [**nano /etc/sudoers**](#nano-etcsudoers)
  ...
  - [**mcedit /etc/openssh/sshd_config**](#mcedit-etcopensshsshd_config)
  - [**mcedit /root/banner**](#mcedit-rootbanner)
  ...
  - [**nano /etc/apt/sources.list**](#nano-etcaptsourceslist)
  - [**apt update**](#apt-update)
  - [**apt install frr -y**](#apt-install-frr--y)
  - [**nano /etc/frr/daemons**](#nano-etcfrrdaemons)
  - [**quit**](#quit)
  - [**exit**](#exit)
  - [**nano /etc/apt/sources.list**](#nano-etcaptsourceslist)
  - [**apt update**](#apt-update)
  ...
  - [**nano /etc/frr/daemons**](#nano-etcfrrdaemons)
  - [**vtysh**](#vtysh)
  - [**do show ip ospf route**](#do-show-ip-ospf-route)
  ...
  - [**apt-get update && apt-get install -y isc-dhcp-server**](#apt-get-update--apt-get-install--y-isc-dhcp-server)
  - [**nano /etc/default/isc-dhcp-server**](#nano-etcdefaultisc-dhcp-server)
  - [**cp /etc/dhcp/dhcpd.conf /etc/dhcp/dhcpd.bkp**](#cp-etcdhcpdhcpdconf-etcdhcpdhcpdbkp)
  - [**nano /etc/dhcp/dhcpd.conf**](#nano-etcdhcpdhcpdconf)
  ...
  - [**Запись**](#запись)
  - [**Тип**](#тип)
  - [**apt-get update && apt-get install -y dnsmasq**](#apt-get-update--apt-get-install--y-dnsmasq)
  - [**systemctl disable bind --now**](#systemctl-disable-bind---now)
  - [**systemctl restart dnsmasq**](#systemctl-restart-dnsmasq)
  - [**systemctl enable dnsmasq --now**](#systemctl-enable-dnsmasq---now)
  ...
  - [**apt-get install task-samba-dc -y**](#apt-get-install-task-samba-dc--y)
  - [**rm -rf /etc/samba/smb.conf**](#rm--rf-etcsambasmbconf)
  - [**samba-tool domain provision**](#samba-tool-domain-provision)
  - [**Realm: AU-TEAM.IRPO**](#realm-au-teamirpo)
  - [**Domain: AU-TEAM**](#domain-au-team)
  - [**Server Role: dc**](#server-role-dc)
  - [**DNS backend: SAMBA_INTERNAL**](#dns-backend-samba_internal)
  - [**DNS forwarder IP address: 192.168.1.2**](#dns-forwarder-ip-address-19216812)
  - [**cp /var/lib/samba/private/krb5.conf /etc/krb5.conf**](#cp-varlibsambaprivatekrb5conf-etckrb5conf)
  - [**systemctl disable bind --now**](#systemctl-disable-bind---now)
  - [**systemctl enable samba --now**](#systemctl-enable-samba---now)
  - [**mcedit /etc/samba/smb.conf**](#mcedit-etcsambasmbconf)
  - [**interfaces = lo ens18**](#interfaces--lo-ens18)
  - [**bind interfaces only = yes**](#bind-interfaces-only--yes)
  - [**systemctl restart samba**](#systemctl-restart-samba)
  - [**samba-tool domain info 127.0.0.1 **](#samba-tool-domain-info-127001-)
  - [**или**](#или)
  - [**samba-tool domain info 192.168.3.2**](#samba-tool-domain-info-19216832)
  - [**mcedit /etc/dnsmasq.conf**](#mcedit-etcdnsmasqconf)
  - [**server=/au-team.irpo/192.168.3.2**](#serverau-teamirpo19216832)
  - [**systemctl restart dnsmasq**](#systemctl-restart-dnsmasq)
  - [**acc**](#acc)
  - [**Домен: au-team.irpo**](#домен-au-teamirpo)
  - [**samba-tool user create hquser(№) P@ssw0rd**](#samba-tool-user-create-hquser-pssw0rd)
  - [**samba-tool user list**](#samba-tool-user-list)
  - [**samba-tool group add hq**](#samba-tool-group-add-hq)
    - [**samba-tool group addmembers hq hquser1,hquser2,hquser3,hquser4,hquser5**](#samba-tool-group-addmembers-hq-hquser1hquser2hquser3hquser4hquser5)
  - [**id**](#id)
  - [**nano /etc/sudoers**](#nano-etcsudoers)
  - [**chmod 4755 /usr/bin/sudo**](#chmod-4755-usrbinsudo)
  - [**sudo -l**](#sudo--l)
  - [**sudo id**](#sudo-id)
  - [Задание 2. Сконфигурируйте файловое хранилище на сервере HQ-SRV](#задание-2-сконфигурируйте-файловое-хранилище-на-сервере-hq-srv)
    - [**mdadm --create /dev/md0 --level=0 --raid-device=2 /dev/sdb /dev/sdc**](#mdadm---create-devmd0---level0---raid-device2-devsdb-devsdc)
  - [**mdadm --detail --scan > /etc/mdadm.conf**](#mdadm---detail---scan--etcmdadmconf)
  - [**fdisk /dev/md0**](#fdisk-devmd0)
  - [**lsblk /dev/md0**](#lsblk-devmd0)
  - [**mkfs.ext4 /dev/md0p1**](#mkfsext4-devmd0p1)
  - [**mkdir /raid**](#mkdir-raid)
  - [**mount /dev/md0p1 /raid**](#mount-devmd0p1-raid)
  - [**export EDITOR=mcedit**](#export-editormcedit)
  - [**systemctl --force --full edit raid.mount**](#systemctl---force---full-edit-raidmount)
  - [**systemctl enable raid.mount --now**](#systemctl-enable-raidmount---now)
  - [**mount -a**](#mount--a)
  - [**df -h**](#df--h)
  ...
  - [**apt-get update**](#apt-get-update)
  - [**apt-get install nfs-server -y**](#apt-get-install-nfs-server--y)
  - [**mkdir /raid/nfs**](#mkdir-raidnfs)
  - [**chmod 777 /raid/nfs**](#chmod-777-raidnfs)
  - [**mcedit /etc/exports**](#mcedit-etcexports)
  - [**exportfs -a**](#exportfs--a)
  - [**systemctl enable nfs-server --now**](#systemctl-enable-nfs-server---now)
  - [**apt-get update**](#apt-get-update)
  - [**apt-get install nfs-clients -y **](#apt-get-install-nfs-clients--y-)
  - [**mkdir /mnt/nfs**](#mkdir-mntnfs)
  - [**systemctl --force --full edit mnt-nfs.mount**](#systemctl---force---full-edit-mnt-nfsmount)
  - [**mount -a**](#mount--a)
  - [**df -h**](#df--h)
  - [**touch /mnt/nfs/test**](#touch-mntnfstest)
  - [**ls -lah /raid/nfs**](#ls--lah-raidnfs)
  ...
  - [**apt-get update && apt-get install chrony**](#apt-get-update--apt-get-install-chrony)
  - [**nano /etc/chrony/chrony.conf**](#nano-etcchronychronyconf)
  - [**systemctl restart chronyd**](#systemctl-restart-chronyd)
  - [**apt-get update && apt-get install chrony**](#apt-get-update--apt-get-install-chrony)
  - [**nano /etc/chrony/chrony.conf**](#nano-etcchronychronyconf)
  - [**server 172.16.1.1 iburst**](#server-1721611-iburst)
  - [**systemctl restart chrony**](#systemctl-restart-chrony)
  - [**systemctl enable chrony**](#systemctl-enable-chrony)
  - [**chronyc sources**](#chronyc-sources)
  - [**mcedit /etc/chrony.conf**](#mcedit-etcchronyconf)
  - [**server 172.16.1.1 iburst**](#server-1721611-iburst)
  - [**chronyc sources**](#chronyc-sources)
  - [**mcedit /etc/chrony.conf**](#mcedit-etcchronyconf)
  - [**server 172.16.1.1 iburst**](#server-1721611-iburst)
  - [**chronyc sources**](#chronyc-sources)
  - [**mcedit /etc/chrony.conf**](#mcedit-etcchronyconf)
  - [**Комментируем строки c rtcsync и pool:**](#комментируем-строки-c-rtcsync-и-pool)
  - [**server 172.16.1.1 iburst**](#server-1721611-iburst)
  - [**chronyc sources**](#chronyc-sources)
  - [Задание 5. Сконфигурируйте ansible на сервере BR-SRV:](#задание-5-сконфигурируйте-ansible-на-сервере-br-srv)
  - [**apt-get update && apt-get install -y ansible sshpass**](#apt-get-update--apt-get-install--y-ansible-sshpass)
  - [**mcedit /etc/ansible/hosts**](#mcedit-etcansiblehosts)
  ...
  - [**systemctl disable ahttpd --now**](#systemctl-disable-ahttpd---now)
  - [**apt-get install docker-engine docker-compose -y**](#apt-get-install-docker-engine-docker-compose--y)
  - [**systemctl enable docker --now**](#systemctl-enable-docker---now)
  - [**systemctl status docker**](#systemctl-status-docker)
  - [**mkdir /dev/add_cd**](#mkdir-devadd_cd)
  - [**mount /dev/sr0 /mnt/add_cd**](#mount-devsr0-mntadd_cd)
  - [**ls /mnt/add_cd**](#ls-mntadd_cd)
  - [**cp -r /mnt/add_cd/docker /root**](#cp--r-mntadd_cddocker-root)
  - [**Is -lah docker/**](#is--lah-docker)
  - [**docker image load -i /root/docker/site_latest.tar**](#docker-image-load--i-rootdockersite_latesttar)
  - [**docker image load -i /root/docker/mariadb_latest.tar**](#docker-image-load--i-rootdockermariadb_latesttar)
  - [**docker images**](#docker-images)
  - [**mkdir testapp**](#mkdir-testapp)
  - [**cd testapp**](#cd-testapp)
  - [**mcedit docker-compose.yaml**](#mcedit-docker-composeyaml)
  - [**docker compose up -d**](#docker-compose-up--d)
  - [**docker ps**](#docker-ps)
  - [**http://192.168.3.2:8080**](#http192168328080)
  - [**export EDITOR=mcedit**](#export-editormcedit)
  - [**crontab -e**](#crontab--e)
  - [Задание 7. Разверните веб приложение на сервере HQ-SRV:](#задание-7-разверните-веб-приложение-на-сервере-hq-srv)
  - [**HQ-SRV:**](#hq-srv)
  - [**apt-get update && apt-get install –y lamp-server**](#apt-get-update--apt-get-install-y-lamp-server)
  - [**mount /dev/sr0 /mnt/**](#mount-devsr0-mnt)
  - [**ls /mnt/**](#ls-mnt)
  - [**cp /mnt/web/index.php /var/www/html**](#cp-mntwebindexphp-varwwwhtml)
  - [**cp /mnt/web/logo.png /var/www/html**](#cp-mntweblogopng-varwwwhtml)
  - [**mcedit /var/www/html/index.php**](#mcedit-varwwwhtmlindexphp)
  - [**mcedit /etc/httpd2/conf/sites-available/default.conf**](#mcedit-etchttpd2confsites-availabledefaultconf)
  - [**systemctl enable --now mariadb**](#systemctl-enable---now-mariadb)
  - [**mariadb –u root**](#mariadb-u-root)
  - [**CREATE DATABASE webdb;**](#create-database-webdb)
  - [**CREATE USER ‘web’@’localhost’ IDENTIFIED BY ‘P@ssw0rd’;**](#create-user-weblocalhost-identified-by-pssw0rd)
    - [**GRANT ALL PRIVILEGES ON webdb.* TO ‘web’@’localhost’ WITH GRANT OPTION;**](#grant-all-privileges-on-webdb-to-weblocalhost-with-grant-option)
  - [**EXIT;**](#exit)
  - [**mariadb –u web –p –D webdb < /mnt/web/dump.sql**](#mariadb-u-web-p-d-webdb--mntwebdumpsql)
  ...
  - [Задание 8. На маршрутизаторах сконфигурируйте статическую трансляцию портов](#задание-8-на-маршрутизаторах-сконфигурируйте-статическую-трансляцию-портов)
    - [**iptables -t nat -A PREROUTING -d 172.16.2.2 -p tcp --dport 8080 -j DNAT --to-destination 192.168.3.2:8080**](#iptables--t-nat--a-prerouting--d-1721622--p-tcp---dport-8080--j-dnat---to-destination-192168328080)
    - [**iptables -t nat -A PREROUTING -d 172.16.2.2 -p tcp --dport 2026 -j DNAT --to-destination 192.168.3.2:2026**](#iptables--t-nat--a-prerouting--d-1721622--p-tcp---dport-2026--j-dnat---to-destination-192168322026)
  - [**iptables-save > /etc/rules.v4**](#iptables-save--etcrulesv4)
  ...
  - [**nano /etc/nginx/sites-available/default**](#nano-etcnginxsites-availabledefault)
  ...
  - [**apt-get install yandex-browser-stable -y**](#apt-get-install-yandex-browser-stable--y)
  ...
  - [**mount /dev/sr0/mnt/**](#mount-devsr0mnt)
  - [**mcedit import_user.sh**](#mcedit-import_usersh)
  - [**chmod +x import_user.sh**](#chmod-x-import_usersh)
  ...
  - [**apt-get install -y openssl-gost-engine**](#apt-get-install--y-openssl-gost-engine)
  - [**control openssl-gost enabled**](#control-openssl-gost-enabled)
    - [**openssl genpkey -algorithm gost2012_256 -pkeyopt paramset:TCB -out ca.key**](#openssl-genpkey--algorithm-gost2012_256--pkeyopt-paramsettcb--out-cakey)
    - [**openssl req -new -x509 -md_gost12_256 -days 30 -key ca.key -out ca.cer**](#openssl-req--new--x509--md_gost12_256--days-30--key-cakey--out-cacer)
    - [**openssl genpkey -algorithm gost2012_256 -pkeyopt paramset:A -out web.au-team.irpo.key**](#openssl-genpkey--algorithm-gost2012_256--pkeyopt-paramseta--out-webau-teamirpokey)
    - [**openssl genpkey -algorithm gost2012_256 -pkeyopt paramset:A -out docker.au-team.irpo.key**](#openssl-genpkey--algorithm-gost2012_256--pkeyopt-paramseta--out-dockerau-teamirpokey)
    - [**openssl req -new  -md_gost12_256 -key web.au-team.irpo.key -out web.au-team.irpo.csr**](#openssl-req--new---md_gost12_256--key-webau-teamirpokey--out-webau-teamirpocsr)
    - [**openssl req -new  -md_gost12_256 -key docker.au-team.irpo.key -out docker.au-team.irpo.csr**](#openssl-req--new---md_gost12_256--key-dockerau-teamirpokey--out-dockerau-teamirpocsr)
    - [**openssl x509 -req -in web.au-team.irpo.csr -CA ca.cer -CAkey ca.key -CAcreateserial -out web.au-team.irpo.cer -days 30**](#openssl-x509--req--in-webau-teamirpocsr--ca-cacer--cakey-cakey--cacreateserial--out-webau-teamirpocer--days-30)
  - [**apt-get install openssh-server**](#apt-get-install-openssh-server)
  - [**nano /etc/ssh/sshd_config**](#nano-etcsshsshd_config)
  - [**systemctl restart sshd**](#systemctl-restart-sshd)
    - [**scp {web,docker}.au-team.irpo.{key,cer} root@172.16.1.1:~/**](#scp-webdockerau-teamirpokeycer-root1721611)
  - [**mkdir /etc/nginx/ssl**](#mkdir-etcnginxssl)
  - [**cp web.au-team.irpo.* /etc/nginx/ssl**](#cp-webau-teamirpo-etcnginxssl)
  - [**cp docker.au-team.irpo.* /etc/nginx/ssl**](#cp-dockerau-teamirpo-etcnginxssl)
  - [**nano /etc/nginx/sites-available/default**](#nano-etcnginxsites-availabledefault)
  - [**nginx -t**](#nginx--t)
  - [**Если на ISP debian-подобная система:**](#если-на-isp-debian-подобная-система)
  - [**openssl engine gost -t**](#openssl-engine-gost--t)
  - [**openssl_conf=openssl_def**](#openssl_confopenssl_def)
    - [Если на ISP ALT подобная система](#если-на-isp-alt-подобная-система)
  - [**apt-get install -y openssl-gost-engine**](#apt-get-install--y-openssl-gost-engine)
  - [**control openssl-gost enabled**](#control-openssl-gost-enabled)
  - [**systemctl restart nginx**](#systemctl-restart-nginx)
  - [**scp ca.cer user@192.168.200.2:~/**](#scp-cacer-user1921682002)
    - [**cp /home/user/ca.cer /etc/pki/ca-trust/source/anchors/ && update-ca-trust**](#cp-homeusercacer-etcpkica-trustsourceanchors--update-ca-trust)
  - [**cd /home/user/Загрузки/linux-amd64**](#cd-homeuserзагрузкиlinux-amd64)
  - [**apt-get install -y cryptopro-preinstall**](#apt-get-install--y-cryptopro-preinstall)
  - [**./install_gui.sh**](#install_guish)
  - [**https://web.au-team.irpo:**](#httpswebau-teamirpo)
  - [**docker exec -it testapp ash**](#docker-exec--it-testapp-ash)
  - [**vi app/site/site.html**](#vi-appsitesitehtml)
  ...
  - [**sudo apt install -y strongswan strongswan-pki**](#sudo-apt-install--y-strongswan-strongswan-pki)
  - [**nano /etc/ipsec.conf**](#nano-etcipsecconf)
  - [**install_routes = no**](#install_routes--no)
  - [**systemctl restart strongswan**](#systemctl-restart-strongswan)
  - [**systemctl restart strongswan-starter**](#systemctl-restart-strongswan-starter)
  - [**ipsec statusall**](#ipsec-statusall)
  - [**vtysh**](#vtysh)
  - [**show run**](#show-run)
  - [**conf t**](#conf-t)
  - [**interface gre1**](#interface-gre1)
  - [**no ip ospf authentication message-digest**](#no-ip-ospf-authentication-message-digest)
  - [**no ip ospf message-digest-key 1 md5 123qweR%**](#no-ip-ospf-message-digest-key-1-md5-123qwer)
  - [**ip ospf network broadcast**](#ip-ospf-network-broadcast)
  - [**end**](#end)
  - [**wr**](#wr)
  - [**exit**](#exit)
  - [**Теперь проделываем тожесамое на BR-RTR: **](#теперь-проделываем-тожесамое-на-br-rtr-)
  - [**vtysh**](#vtysh)
  - [**show run**](#show-run)
  - [**conf t**](#conf-t)
  - [**interface gre1**](#interface-gre1)
  ...
  - [**nano /etc/rules.v4**](#nano-etcrulesv4)
  - [**iptables-restore < /etc/rules.v4**](#iptables-restore--etcrulesv4)
  - [Задание 5. Настройте принт-сервер cups на сервере HQ-SRV:](#задание-5-настройте-принт-сервер-cups-на-сервере-hq-srv)
  - [**apt-get update && apt-get install -y cups cups-pdf**](#apt-get-update--apt-get-install--y-cups-cups-pdf)
  - [**systemctl enable --now cups**](#systemctl-enable---now-cups)
  - [**cupsctl --share-printers --remote-any**](#cupsctl---share-printers---remote-any)
  ...
  - [**apt-get update && apt-get install rsyslog -y **](#apt-get-update--apt-get-install-rsyslog--y-)
  - [**systemctl enable rsyslog**](#systemctl-enable-rsyslog)
  - [**mcedit /etc/rsyslog.d/***](#mcedit-etcrsyslogd)
  - [**mkdir -p /opt/HQ-RTR /opt/BR-RTR /opt/BR-SRV**](#mkdir--p-opthq-rtr-optbr-rtr-optbr-srv)
  - [**chown 777 /opt -R**](#chown-777-opt--r)
  - [**systemctl restart rsyslog**](#systemctl-restart-rsyslog)
  - [**nano /etc/rsyslog.conf**](#nano-etcrsyslogconf)
  - [***.warning @@192.168.1.2:514**](#warning-19216812514)
  - [**systemctl restart rsyslog**](#systemctl-restart-rsyslog)
  - [**nano /etc/rsyslog.conf**](#nano-etcrsyslogconf)
  - [***.warning @@192.168.1.2:514**](#warning-19216812514)
  - [**systemctl restart rsyslog**](#systemctl-restart-rsyslog)
  ...
  - [***.warning @@192.168.1.2:514**](#warning-19216812514)
  - [**systemctl restart rsyslog**](#systemctl-restart-rsyslog)
  - [**mcedit /etc/logrotate.d/opt-logs**](#mcedit-etclogrotatedopt-logs)
  - [**logrotate -d /etc/logrotate.conf**](#logrotate--d-etclogrotateconf)
  - [**logger -p user.warning "Test log from HQ-RTR"**](#logger--p-userwarning-test-log-from-hq-rtr)
  - [**tail -f /opt/HQ-RTR/syslog.log**](#tail--f-opthq-rtrsysloglog)
  ...
  - [**sudo apt update**](#sudo-apt-update)
  - [**sudo apt install -y netdata**](#sudo-apt-install--y-netdata)
  - [**sudo systemctl enable –now netdata**](#sudo-systemctl-enable-now-netdata)
  - [**mcedit /etc/dnsmasq.conf**](#mcedit-etcdnsmasqconf)
  - [**systemctl restart dnsmasq**](#systemctl-restart-dnsmasq)
  - [**apt-get install -y nginx apache2-htpasswd**](#apt-get-install--y-nginx-apache2-htpasswd)
  - [**htpasswd -cb /etc/nginx/.netdata-pass admin P@ssw0rd**](#htpasswd--cb-etcnginxnetdata-pass-admin-pssw0rd)
    - [**ln -s /etc/nginx/sites-available.d/default.conf /etc/nginx/sites-enabled.d/**](#ln--s-etcnginxsites-availableddefaultconf-etcnginxsites-enabledd)
  - [**nginx -t**](#nginx--t)
  - [**systemctl restart nginx**](#systemctl-restart-nginx)
  - [**sudo apt update**](#sudo-apt-update)
  - [**sudo apt install -y netdata**](#sudo-apt-install--y-netdata)
  ...
  - [**apt-get update && apt-get install fail2ban**](#apt-get-update--apt-get-install-fail2ban)
  ...
  - [**apt-get updateapt-get dist-upgradeupdate-kernel**](#apt-get-updateapt-get-dist-upgradeupdate-kernel)
  - [**apt-get install kernel-headers-modules-std-def**](#apt-get-install-kernel-headers-modules-std-def)
  ...
  - [**apt-get install gcc**](#apt-get-install-gcc)
  - [**apt-get install make**](#apt-get-install-make)
  - [**chmod +x /usr/sshuser/CyberBackup_17_64-bit.x86_64**](#chmod-x-usrsshusercyberbackup_17_64-bitx86_64)
  - [**/usr/sshuser/CyberBackup_17_64-bit.x86_64**](#usrsshusercyberbackup_17_64-bitx86_64)
  - [**apt-get updateapt-get dist-upgradeupdate-kernel**](#apt-get-updateapt-get-dist-upgradeupdate-kernel)
  - [**apt-get install kernel-headers-modules-std-def**](#apt-get-install-kernel-headers-modules-std-def)
  - [**apt-get install gcc**](#apt-get-install-gcc)
  - [**apt-get install make**](#apt-get-install-make)
